...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        ...
        User tester = userLoggedInService.getLoggedInUser(); //saving the logged in user in user object
        return testRequestQueryService.findByTester(tester); //returns the test requests assigned to logged in tester
